...
datasets. It uses large language models (LLMs) to create realistic data that can
be used for:
...
- **Bias Detection** - Create datasets with protected attributes for fairness
  analysis
...
cloud API service. According to the
[official documentation](https://docs.nvidia.com/nemo/microservices/latest/design-synthetic-data-from-scratch-or-seeds/index.html),
...
The generated datasets integrate seamlessly with the existing bias detection
system:
