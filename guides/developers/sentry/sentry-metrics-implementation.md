...
This document summarizes where Sentry metrics have been instrumented throughout
the Pixelated Empathy codebase.

## Overview

Metrics have been strategically placed in the most efficient and logical
