...
Pixelated Empathy exposes APIs for interacting with The Empathy Gym™, the
Emotional Intelligence Engine, and supporting services. This reference covers
the primary endpoints you'll work with.
...
Tokens are issued on login and expire according to your environment
configuration. See [/developers/getting-started](/developers/getting-started)
for setup.
...
For real-time session communication, connect to the WebSocket server:
